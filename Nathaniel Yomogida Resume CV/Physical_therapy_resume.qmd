...
\begin{large}
  ...
  \begin{multicols}{2}
    \begin{flushleft}
      \hspace{1 mm} {\bf Doctor of Physical Therapy}\\
      \hspace{11 mm}San Diego State University
    \end{flushleft}
    \begin{flushright}
    Charlottesville, VA
    \end{flushright}
...
\begin{large}
  \begin{multicols}{2}
    \begin{flushleft}
      \hspace{1 mm} {\bf B.S. Kinesiology - Exercise Science}\\
      \hspace{11 mm}California State University Long Beach
    \end{flushleft}
    \begin{flushright}
    Provo, UT
    \end{flushright}
...
\begin{large}{\bf CLINICAL EXPERIENCE}
  \vspace{3pt}
  \hrule
  \begin{multicols}{2}
    \begin{flushleft}{
    ...
    \end{flushleft}
    \begin{flushright}
    \begin{small}(1mth)\end{small} April 2024-Present\\
    New York, NY
    \end{flushright}
  \end{multicols}
\end{large}
